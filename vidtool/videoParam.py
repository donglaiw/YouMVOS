...
class videoParam(object):
    def __init__(self):
        ...
        self.FRAME_ROOT = self.FOLDER_DOWNLOAD + "{}/" # video name, suffix
        self.FRAME_NAME = self.FRAME_ROOT + "frame{}/image_%05d.png" # video name, suffix
        self.FRAME_NAME_DS = self.FOLDER_WEB + "frame_ds/{}/image_%05d.png" # video name 
        self.FRAME_NAME_VAST = self.PROCESSOR_VAST + "im/image_%05d.png" # video name 
        self.FRAME_OFFSET = 1
